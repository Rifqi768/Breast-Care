...
class MultiApp:
    ...
    def run():
        with st.sidebar:
            st.image('img/breast-cancer.png', use_column_width=True)
            app = option_menu(
                menu_title='Breast Care ',
                options=['Home','News','Predict','Cancer Data','Feedback','Account','about'],
                icons=['house-fill','newspaper','graph-up','database','chat-text-fill','person-circle','info-circle-fill'],
